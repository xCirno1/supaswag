...
export const addPatient = async (req: Request, res: Response) => {
  try {
    const { name, age, room, conditions, medications, allergies, priority } = req.body;
    ...
    const insertResult = await pool.query(
      `INSERT INTO patients (id, name, age, room, conditions, medications, allergies, priority) 
       VALUES ($1, $2, $3, $4, $5, $6, $7, $8) RETURNING *`,
      [newId, name, age, room, conditions || ['New Patient Admission'], medications || ['None'], allergies || ['None'], priority ?? 0]
    );
...
export const updatePatientPriority = async (req: Request, res: Response) => {
  try {
    ...
    // Priority change can affect meal plan ordering
